...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: SM_z65RkSkwoO/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: MJkr-HcQeNStlP/icon
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__jCwMc)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__juNf1)}
                role={"img"}
              />
            ),
